...
public class AddressRestController {
    ...
    public ResponseEntity<ApiResponse<ShippingAddrDto>> saveAddress(@RequestBody ShippingAddrDto addrDto
    ...
    public ResponseEntity<ApiResponse<ShippingAddrDto>> updateAddress(@RequestBody ShippingAddrDto addrDto,
                                                                      @PathVariable Integer customerId){
